...
/*   Updated: 2021/06/11 20:50:36 by tmatis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

void	draw_keys(t_frame menu_frame)
{
...
t_frame	get_menu_frame(t_info info)
{
	...
	draw_keys(menu_frame);
	return (menu_frame);
}

void	put_menu_text_2(t_info info)
{
	...
	mlx_string_put(info.mlx, info.win,
		75, 690, 0xFFFFFF, "show/hide help menu");
}
